...
def get_args_parser():
    ...
    parser.add_argument('--num_obj_classes', type=int, default=83,
                        help="Number of object classes")
    parser.add_argument('--num_verb_classes', type=int, default=122,
                        help="Number of verb classes")
    parser.add_argument('--pretrained', type=str, default='checkpoint.pth',
